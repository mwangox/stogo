...
const (
	...
	KVService_SetSecretKeyService_FullMethodName             = "/KVService/SetSecretKeyService"
...
type KVServiceClient interface {
	...
	//Set a secret key
	SetSecretKeyService(ctx context.Context, in *SetKeyRequest, opts ...grpc.CallOption) (*SetKeyResponse, error)
	//Delete a key
...
func (c *kVServiceClient) SetSecretKeyService(ctx context.Context, in *SetKeyRequest, opts ...grpc.CallOption) (*SetKeyResponse, error) {
	out := new(SetKeyResponse)
	err := c.cc.Invoke(ctx, KVService_SetSecretKeyService_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KVServiceServer interface {
	...
	//Set a secret key
	SetSecretKeyService(context.Context, *SetKeyRequest) (*SetKeyResponse, error)
	//Delete a key
...
func (UnimplementedKVServiceServer) SetSecretKeyService(context.Context, *SetKeyRequest) (*SetKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetSecretKeyService not implemented")
}
...
func _KVService_SetSecretKeyService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVServiceServer).SetSecretKeyService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KVService_SetSecretKeyService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServiceServer).SetSecretKeyService(ctx, req.(*SetKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KVService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetSecretKeyService",
			Handler:    _KVService_SetSecretKeyService_Handler,
		},
		{
